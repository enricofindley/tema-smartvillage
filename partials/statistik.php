...
<div class="box-body">
	<div class="single_page_area">
		<h2 class="font-bold text-heading text-lg lg:text-2xl">Data Demografi Berdasar <?= $heading; ?></h2>
		<div class="divider"></div>
	</div>
	<div class="box-stats d-flex justify-content-end">
		<div class="btn-group-xs mb-5">
...
<div class="box-header with-border">
	<h2 class="font-bold text-heading text-lg lg:text-2xl">Tabel <?= $heading ?></h2><br>
</div>
<div class="box-body">
	<div class="overflow-x-auto">
		<table class="table table-compact w-full">
			<thead>
				...
				<tr>
					<th style='text-align:inherit'>n</th><th style='text-align:inherit'>%</th>
					<?php if ($jenis_laporan == 'penduduk'):?>
						<th style='text-align:inherit'>n</th><th style='text-align:inherit'>%</th>
						<th style='text-align:inherit'>n</th><th style='text-align:inherit'>%</th>
					<?php endif;?>
		...
		<div style="float: right;">
			<button id='tampilkan' onclick="toggle_tampilkan();" class="btn btn-primary">Tampilkan Nol</button>
		</div>
	</div>
</div>
			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="box box-info">
						...
						<div class="overflow-x-auto">
							<table class="table table-compact w-full" id="peserta_program">
								<thead>
									<tr>
										<th>No</th>
										<th>Program</th>
