...
<meta name='theme' content='coco' />
<meta name='designer' content='Enrico Findley' />
<meta name='theme:designer' content='Enrico Findley' />
<meta name='theme:version' content='<?= THEME_VERSION ?>' />
<meta name='keywords' content="Sistem Informasi <?= $desa_title ?> Kecamatan <?= $desa['nama_kecamatan']; ?> Kabupaten <?= $desa['nama_kabupaten']; ?>" />
...
<?php else: ?>
  ...
  <meta itemprop="name" content="Sistem Informasi <?= $desa_title ?>"/>
...
<script>
  ...
  const APP_TITLE = 'Sistem Informasi <?= $desa_title ?>';
  const APP_SHORT_TITLE = '<?= $desa_title ?>';
